...
public class HashDictionaryADTTest<K, V> 
{
	...
	public void addTest() 
	{
		 HashDictionaryADT<String, String> _addPhoneBook 
		= new HashDictionaryADT<String, String>();
		...
		_addPhoneBook.add(_banana, _0104);
		assertEquals(_addPhoneBook.getSize(), 3);
	}
	...
	public void removeTest() 
	{
		...
		HashDictionaryADT<String, String> _removePhoneBook 
		= new HashDictionaryADT<String, String>();
	...
	{
		// creates a new phone book
		HashDictionaryADT<String, String> _getValuePhoneBook 
		= new HashDictionaryADT<String, String>();
	...
	{
		// creates a new phone book
		HashDictionaryADT<String, String> _containsPhoneBook = new HashDictionaryADT<String, String>();
	...
	{
		HashDictionaryADT<K, V> _keyIteratorPhoneBook 
		= new HashDictionaryADT<K, V>();
	...
	{
		HashDictionaryADT<K, V> _valueIteratorPhoneBook 
		= new HashDictionaryADT<K, V>();
	...
	{
		HashDictionaryADT<String, String> _isEmptyPhoneBook 
		= new HashDictionaryADT<String, String>();
	...
	public void isFullTest()
	{
		...
		HashDictionaryADT<String, String> _isFullPhoneBook 
		= new HashDictionaryADT<String, String>();
	...
	{
		// creates a new phone book
		HashDictionaryADT<String, String> _getSizePhoneBook 
		= new HashDictionaryADT<String, String>();
	...
	{
		// creates a new phone book
		HashDictionaryADT<String, String> _clearPhoneBook
		= new HashDictionaryADT<String, String>();
